        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>Phone</strong> columns. Agents whose name already exists
              are skipped. New agents left without a phone number get a
              placeholder that you can update later.
            </DialogDescription>
          </DialogHeader>
